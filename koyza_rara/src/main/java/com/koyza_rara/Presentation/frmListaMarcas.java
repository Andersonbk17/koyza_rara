 ...
 * @author Anderson
 */
public class frmListaMarcas extends javax.swing.JDialog {
    ...
    private Marca marcaNaTabela;
    
    public frmListaMarcas(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void jButtonNovoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonNovoActionPerformed
      ...
      frmCadastroMarcas janela = new frmCadastroMarcas(null, rootPaneCheckingEnabled);
      this.dispose();
    ...
    private void jTableMarcasMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTableMarcasMouseClicked
        ...
        idSelecionadoNaTabela = jTableMarcas.getSelectedRow();
        marcaNaTabela = lista.get(idSelecionadoNaTabela);
